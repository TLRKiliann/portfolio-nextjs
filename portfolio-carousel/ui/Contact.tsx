...
<section className="relative py-12 bg-black overflow-hidden">
  ...
  <div className="container mx-auto px-4 text-center relative z-10">
    ...
    <div className="absolute -inset-1 mx-auto w-36 h-36 rounded-full border border-cyan-400/30 animate-pulse pointer-events-none" />
    </motion.div>
    ...
    >
      <motion.a
        ...
        className="bg-black bg-opacity-50 p-3 rounded-full border border-cyan-500/50 hover:border-cyan-500 hover:shadow-[0_0_15px_rgba(0,255,255,0.5)] transition-all backdrop-blur-sm"
        aria-label="GitHub"
      >
      ...
      <motion.a
        ...
        rel="noopener noreferrer"
        whileHover={{ y: -5, scale: 1.1 }}
        className="bg-black bg-opacity-50 p-3 rounded-full border border-fuchsia-500/50 hover:border-fuchsia-500 hover:shadow-[0_0_15px_rgba(255,0,255,0.5)] transition-all backdrop-blur-sm"
        aria-label="CodePen"
      >
        <svg className="w-8 h-8 text-fuchsia-400" fill="currentColor" viewBox="0 0 24 24">
      ...
      <motion.a
        ...
        rel="noopener noreferrer"
        whileHover={{ y: -5, scale: 1.1 }}
        className="bg-black bg-opacity-50 p-3 rounded-full border border-red-500/50 hover:border-red-500 hover:shadow-[0_0_15px_rgba(255,0,0,0.5)] transition-all backdrop-blur-sm"
        aria-label="YouTube"
      >

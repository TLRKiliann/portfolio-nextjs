...
<section className="relative min-h-[100dvh] bg-black overflow-hidden">
  ...
  <div className="container mx-auto px-4 relative z-10 flex flex-col min-h-screen">
    {/* Espace en haut - réduit sur mobile */}
    ...
    <motion.h2
      ...
      className="text-3xl sm:text-4xl md:text-5xl font-bold mx-auto mb-6 sm:mb-8 font-mono text-center"
    >
    ...
    <motion.p
      ...
      className="text-sm sm:text-base md:text-xl mb-8 sm:mb-10 md:mb-12 max-w-2xl mx-auto text-cyan-400 font-mono tracking-wide text-center px-2"
    >
      [ SYSTEM.MSG ] &gt; Prêt à transformer vos idées en réalité. Contactez-moi.
    </motion.p>
    
    <div className='flex items-center justify-center w-full mb-10 sm:mb-12 md:mb-16'>
      <motion.a
    ...
    <motion.div
      ...
      className="mb-10 sm:mb-12 md:mb-16 relative flex justify-center"
    >
      <div className="relative">
        <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full overflow-hidden border-2 border-cyan-400 shadow-[0_0_20px_rgba(0,255,255,0.5)] relative">
          <Image
    ...
    <motion.div
      ...
      className="flex justify-center gap-3 sm:gap-4 md:gap-6 flex-wrap mb-12 sm:mb-16"
    >
      <motion.a
    ...
    <motion.p
      ...
      className="text-xs text-cyan-500/50 mt-8 sm:mt-12 pb-6 sm:pb-8 pt-4 sm:pt-6 border-t border-cyan-500/20 font-mono text-center"
    >
